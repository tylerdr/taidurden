...
export const metadata=createPageMetadata({title:"Project Directory — Ty Dirt / Tai Durden",description:"All registered ventures, shared systems and linked identities, with operating responsibility and proposed customer-value contracts.",path:"/ventures"});
